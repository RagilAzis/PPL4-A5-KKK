...
import InputDataPeserta from "./pages/InputDataPeserta";
      ...
      <Router>
        <Sidebar>
          <Routes>
            ...
            <Route
              path="/master/inputdatapeserta"
              element={<InputDataPeserta />}
            />
            ...
            <Route
              ...
              element={<RepGradeInterview />}
            />
            <Route
              path="/report/printgradeinterview"
              element={<PrintGradeInterview />}
            />
